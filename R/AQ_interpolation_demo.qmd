...
out = paste0(c("aq_interpolated", pollutant, stat, y, m, station_area_type), collapse = "_")
out = paste0(out, ".tif")
stars::write_stars(result, layer = "aq_interpolated", file.path("tests", out))
