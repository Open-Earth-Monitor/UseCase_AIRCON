...
Model prediction and Kriging output are merged using `combine_results()`. To limit the linear model prediction to certain value range, pass minimum and maximum to `trim_range`.
...
# b = bench::mark(
#   k1 = krige_aq_residuals(aq_at, aq_cov, linmod, n.max = 10, show.vario = T, n.cores = 8),
#   k2 = krige_aq_residuals(aq_at, aq_cov, linmod, n.max = 25, show.vario = T, n.cores = 8),
#   k3 = krige_aq_residuals(aq_at, aq_cov, linmod, n.max = 50, show.vario = T, n.cores = 8),
#   k4 = krige_aq_residuals(aq_at, aq_cov, linmod, n.max = 100, show.vario = T, n.cores = 8),
#   k5 = krige_aq_residuals(aq_at, aq_cov, linmod, n.max = 200, show.vario = T, n.cores = 8),
#   k6 = krige_aq_residuals(aq_at, aq_cov, linmod, show.vario = T, n.cores = 8),
#   check = F, iterations = 1, memory = T, time_unit = "m"
# )
# saveRDS(b, "benchmark_kriging.rds")
```
