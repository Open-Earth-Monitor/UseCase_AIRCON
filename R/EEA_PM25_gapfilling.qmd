...
```{r}
# add time variables
aq = read_parquet("AQ_data/NL_hourly_2015-2023_gaps.parquet") |> 
  filter(between(DatetimeBegin, 
                 as.POSIXct("2017-01-01 00:00:00 CET"), 
                 as.POSIXct("2017-12-31 23:00:00 CET"))) |> 
...
```{r}
file = "supplementary/era5/EU_ssr_hrly_2017.nc"
