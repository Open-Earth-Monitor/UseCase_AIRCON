...
```{r}
countries = c("NL", "BE", "LU")
pollutants = c(7,8,5,6001)

#generate_download_urls(countries, pollutants, 2015, 2023)
check_station_urls()
files = download_station_data()  # ~10 min
```
...
table(poll_table$StationType)
 ...
 arrow::write_parquet(poll_table, "AQ_data/NL_hourly_2015-2023_gaps.parquet")
