...
|    8 | [`AQ_interpolation_demo.qmd`](R/AQ_interpolation_demo.md) `AQ_interpolation_loop_palma.R`                                                                                                                                     | Interpolate AQ data using environmental and socio-economic covariates. Weight and combine individual outputs for rural background, urban background, and urban traffic stations.     |
